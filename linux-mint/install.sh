...
install -Dm644 "$source_dir/ai-usagebar.desktop" "$user_home/.local/share/applications/ai-usagebar.desktop"
install -Dm644 "$source_dir/ai-usagebar-tray.desktop" "$user_home/.config/autostart/ai-usagebar-tray.desktop"
